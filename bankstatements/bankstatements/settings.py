...
#SECRET_KEY = 'django-insecure-7zd3yb3321wk_7v#u*kz!3d*6(x9xf7k+9nl_+7@fetb$a8#b!'
SECRET_KEY = 'c5v4@&%i#$c%n%^35^5d$6t2o0w@-lt*oc@f%#=ao5^!-(n=rb'
...
#STATICFILES_DIRS = (str(BASE_DIR.joinpath('static')),) # this has been added
STATIC_URL = 'static/'
